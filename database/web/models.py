...
class R_and_D(models.Model):
    ...
    lastUpdate = models.TextField(verbose_name="Last update ", null=True, blank=True)
    verifiedBy = models.TextField(verbose_name="Verified by", null=True, blank=True)
    approvedBy = models.TextField(verbose_name="Approved by ", null=True, blank=True)
    ...
    endEffector = models.TextField(verbose_name="End-effector N°", null=True, blank=True)
    impregnationBath = models.TextField(verbose_name="Impregnation bath", null=True, blank=True)
    entryNozzleDiam = models.TextField(verbose_name="Entry nozzle diameter (mm)", null=True, blank=True)
    exitNozzleDiam = models.TextField(verbose_name="Exit nozzle diameter (mm)", null=True, blank=True)

    roomTemperature = models.TextField(verbose_name="Room temperature (°C)", null=True, blank=True)
    roomhumidity = models.TextField(verbose_name="Room humidity (%)", null=True, blank=True)

    brakeForcebobin = models.TextField(verbose_name="Brake force/bobbin (N) (kg) (bar)", null=True, blank=True)
    windingSpeedRange = models.TextField(verbose_name="Windng speed range (mm/s)", null=True, blank=True)

    FVR = models.TextField(verbose_name="FVR (%)", null=True, blank=True)
    compositeDensity = models.TextField(verbose_name="Composite density ρ (g/cm3)", null=True, blank=True)
    porosity = models.TextField(verbose_name="Porosity (%)", null=True, blank=True)
    theoreticalSampleSection = models.TextField(verbose_name="Theoretical sample section (mm²)", null=True, blank=True)
    experimentalSampleSection = models.TextField(verbose_name="Experimental sample section (mm²)", null=True, blank=True)
    aged = models.TextField(verbose_name="Aged / Non-aged", null=True, blank=True)
    temperatureOfTests = models.TextField(verbose_name="Temperature of the tests", null=True, blank=True)

    numberOfSamples = models.TextField(verbose_name="Number of samples", null=True, blank=True)
    configurarion = models.TextField(verbose_name="Configuration", null=True, blank=True)
    sampleLength = models.TextField(verbose_name="Sample length", null=True, blank=True)
    numberOfCycles = models.TextField(verbose_name="Number of cycles", null=True, blank=True)
    sleeve = models.TextField(verbose_name="Sleeve diameter / height (mm)", null=True, blank=True)

    thermalExpansionCoefficient = models.TextField(verbose_name="Thermal expansion coefficient A (/K)", null=True, blank=True)
    thermalConductivity = models.TextField(verbose_name="Thermal conductivity K (W/(m.K))", null=True, blank=True)
