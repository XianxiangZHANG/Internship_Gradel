...
class Part(models.Model):
    ...
    part_gh = models.CharField(verbose_name="Document.gh", max_length=150, null=True, blank=True)
    part_mod = models.CharField(verbose_name="Document.mod", max_length=150, null=True, blank=True)
    part_csv = models.CharField(verbose_name="Document.csv", max_length=150, null=True, blank=True)
    part_rs = models.CharField(verbose_name="Document.rs", max_length=150, null=True, blank=True)
    part_log = models.CharField(verbose_name="Document.log", max_length=150, null=True, blank=True)
    part_mp4 = models.CharField(verbose_name="Document.mp4", max_length=150, null=True, blank=True)
    part_jpg = models.CharField(verbose_name="Document.jpg", max_length=150, null=True, blank=True)
